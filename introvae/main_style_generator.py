...
N_MAPPING_LAYERS = 4
BATCH_SIZE = 64
IMG_DIR = "/media/simon/2TB - Backup/Datasets/anime-faces/data/"
...
generator.load_weights("./weights/generator_64x64_anime_residual_099.h5")
encoder.load_weights("./weights/encoder_64x64_anime_residual_099.h5")
...
for epoch in range(100, epochs):
    ...
    generator.save_weights(f"./weights/generator_64x64_anime_residual_{epoch:03d}.h5")
    encoder.save_weights(f"./weights/encoder_64x64_anime_residual_{epoch:03d}.h5")
